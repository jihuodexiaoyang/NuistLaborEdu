...
import com.ruoyi.framework.shiro.realm.ShiroCasRealm;
...
public class ShiroCasConfig
{
    ...
    @Value("${cas.cassuccessurl}")
    private String casSuccessUrl;

    @Value("${cas.casfailureurl}")
    ...
    public ShiroCasRealm shiroCasRealm(EhCacheManager cacheManager)
    {
        ...
        shiroCasRealm.setAuthorizationCacheName(Constants.SYS_AUTH_CACHE);
        shiroCasRealm.setCasServerUrlPrefix(serverPrefixUrl);
        shiroCasRealm.setCasService(casClientUrl);
        shiroCasRealm.setCacheManager(cacheManager);
    ...
    public UserRealm userRealm(EhCacheManager cacheManager) {
        ...
        userRealm.setAuthenticationCacheName(Constants.SYS_AUTH_CACHE);
    ...
    public CasFilter casFilter(){
        ...
        casFilter.setSuccessUrl(casSuccessUrl);
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        //成功后跳转地址
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>执行到A");
        shiroFilterFactoryBean.setUnauthorizedUrl(unauthorizedUrl);
        //shiroFilterFactoryBean.setSuccessUrl(casSuccessUrl);
        // Shiro连接约束配置，即过滤链的定义
    ...
    public OnlineSessionFilter onlineSessionFilter()
    {
        ...
        onlineSessionFilter.setLoginUrl(casLoginUrl);
